      ...
      <FooterWrapper>
        <Container>
          <FooterContent>
            ...
            <FooterColumn>
              <FooterColumnTitle>Nasze rozwiązania</FooterColumnTitle>
              <FooterLinkList>
                {footerDoc.footer_links.map((link, id) => {
                  return (
                    <FooterLinkItem key={id}>
                      {link.link._linkType == 'Link.web' ? (
                        <StyledLink href={link.link.url} target={'_blank'}>
            ...
            <FooterColumn>
              <FooterColumnTitle>Adres firmy</FooterColumnTitle>
              ...
              <FooterContactItem>
                ...
                <StyledLink href={'/contact'}>{footerDoc.contact_label}</StyledLink>
              </FooterContactItem>
            </FooterColumn>
          </FooterContent>
          <FooterBottom>
